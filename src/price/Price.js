  ...
  return (
    <div id="package" className="pricing_area">
      <div className="container">
        {/**Bu row sadece ana baslik ve icerik icin gercerli olan row */}
        ...
        {/**Burasi sda Price ve minumum advance , premimum component ti  */}
        <div className="row justify-content-center">
          {/**Basic Plan  */}
          <div className="col-lg-4 col-md-6">
            <div className="single-price text-cente">
              {/** Pricing Details */}
              ...
              <ul className="pricing-list">
                <li>
                  <Link to={"/services"}>Minumm Deposit $1000</Link>
                </li>
                <li>
                  <Link to={"/services"}>Maximum Deposit $10000</Link>
                </li>
                <li>
                  <Link to={"/services"}> Add upto 10 Users available</Link>
                </li>
                <li>
